...
typedef enum
{
	...
	CONNECTION_CHECK_TARGET,	/* Checking target myServer properties. */
	CONNECTION_CHECK_STANDBY	/* Checking if myServer is in standby mode. */
} ConnStatusType;
...
typedef enum
{
	PQPING_OK,					/* myServer is accepting connections */
	PQPING_REJECT,				/* myServer is alive but rejecting connections */
...
typedef struct pgNotify
{
	...
	int			be_pid;			/* process ID of notifying myServer process */
