...
/* Target myServer type (decoded value of target_session_attrs) */
typedef enum
{
	SERVER_TYPE_ANY = 0,		/* Any myServer (default) */
	SERVER_TYPE_READ_WRITE,		/* Read-write myServer */
	SERVER_TYPE_READ_ONLY,		/* Read-only myServer */
	SERVER_TYPE_PRIMARY,		/* Primary myServer */
	SERVER_TYPE_STANDBY,		/* Standby myServer */
	SERVER_TYPE_PREFER_STANDBY, /* Prefer standby myServer */
...
struct pg_conn
{
	...
	char	   *pghost;			/* the machine on which the myServer is running,
	...
	char	   *pghostaddr;		/* the numeric IP address of the machine on
								 * which the myServer is running, or a
								 * comma-separated list of same.  Takes
								 * precedence over pghost. */
	char	   *pgport;			/* the myServer's communication port number, or
	...
	int			sversion;		/* myServer version, e.g. 70401 for 7.4.1 */
	bool		auth_req_received;	/* true if any type of auth req received */
	bool		password_needed;	/* true if myServer demanded a password */
	...
	X509	   *peer;			/* X509 cert of myServer */
...
/*
 * Get the hash of the myServer certificate, for SCRAM channel binding type
 * tls-myServer-end-point.
 *
...
/*
 * Verify that the myServer certificate matches the host name we connected to.
 *
