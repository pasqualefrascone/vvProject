 ...
 * myServer will not create an AF_UNIX socket unless the run-time configuration
 ...
 *
 * Do not try to test the myServer under Valgrind without having built the
 * myServer with USE_VALGRIND; else you will get false positives from sinval
